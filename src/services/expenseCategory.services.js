...
export const createExpenseCategoryService = async (adminId , reqBody) => {
   ...
   console.log(reqBody);
    ...
    const res = generateRes(true , "Expense category created successfully" , expenseCategory , 201)
...
export const getExpenseCategoryServiceById = async (expCategoryId , adminId) => {
    ...
    const res = generateRes(true , "Expense category fetched" , expenseCategory , 200)
...
export const getExpenseCategoriesService = async (adminId) => {
    ...
    const res = generateRes(true , "All Expense categories fetched" , expenseCategories , 200)
...
export const updateExpenseCategoryService = async (expCategoryId , adminId ,reqBody) => {
    ...
    const res = generateRes(true , "Expense category updated" , expenseCategory , 200)
...
export const deleteExpenseCategoryService = async (expCategoryId  , adminId) => {
    ...
    const res = generateRes(true , "Expense category deleted" , null , 200)
...
export const categoryInviteService = async (data, {_id , email}) => {
    ...
    for (let i = 0; i < data.length; i++) {
        ...
        //[pending]
        // check the invite alredy exist in invites collections then 
        // if the invite is there
            // invite is accepted === true
                // Throw a error saying invite already accepted
            // else 
                // Throw a error  saying invite already send
    ...
    const res = generateRes(true , "Expense Invite link sent successfully" , null , 200)
...
export const expCategoryInviteAcceptService = async(inviteToken , admin) => {
    ...
    const res = generateRes(true , "Invite Accepted Successfully" , expenseInviteRes , 200)
