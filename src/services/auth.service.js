...
export const registerService = async (reqBody) => {
  ...
  const res = generateRes(true , "Successful Registration" , data , 201)
...
export const loginService = async (reqBody) => {
  ...
  const res = generateRes(true , "Successful Login" , data , 200)
...
export const forgetPasswordService = async (email) => {
  ...
  const res = generateRes(true , "Password reset link sent successfully" , null , 200)
...
export const resetPasswordService = async (resetToken , password) => {
  ...
  const res = generateRes(true , "Password changed successfully" , null , 200)
...
export const refreshTokenService = async (reqRefreshToken) => {
  ...
  const res = generateRes(true , "Password changed successfully" , data , 200)
...
export const logoutService = async (refreshToken) => {
  ...
  client.del(userId).then((data)=>{
    ...
    const res = generateRes(true , "Logout Successfull" , null , 200)
